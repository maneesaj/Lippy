...
{!! Form::open(array('action' => array('SearchController@index'), 'id'=>'submitlip', 'method' => 'POST'))!!}
<ul>
<li><div id="hex">HEX:{!! Form::text('HEX', null) !!}</div></li>
<li><div id="rgb">RGB:{!! Form::text('RGB', null) !!}</div></li>
<li><div id="picked"></div></li>
<li>{!! Form::select('Product', array('Lipstick' => 'Lipstick', 'Lipgloss' => 'Lipgloss')); !!}</li>
<li>{!! Form::submit('Submit')!!}</li>
</ul>
{!! Form::close() !!}
...
<section class="OptionsBox">
        ...
        <a href="{{URL::to('search')}}"><div class="the_box float">
